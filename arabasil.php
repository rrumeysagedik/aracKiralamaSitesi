...

{
 ...
 ?>
 <form action="arabasilsql.php" method="POST" style="font-size: 20px ;top: 300px; position: absolute; margin-left: 80px;  " >
<table align="center">
<tr>
<td>Araba Fiyati:</td>
...
<tr>
<td></td>
<td width="60px" height="40px"><input type="submit" value="Sil" style="font-size: 20px" ></td>
