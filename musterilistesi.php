...

{
  ...
  $sorgu = mysql_query("select *from musteri_girisi") ;
  $ad = mysql_result($sorgu, $sira, 'kullanici_adi');
 $isim = mysql_result($sorgu, $sira, 'kullanici_sifre');

 
  echo "$ad  &emsp;&emsp; &emsp;&emsp; &emsp; &emsp; &emsp; &emsp;   $isim";
  echo "<br>";
  $sira++;
